...
test("can search Google twice", async () => {
  ...
  await driver.findElement(By.name("q")).sendKeys("Street Fighter 6", Key.RETURN);
  ...
  await driver.findElement(By.name("q")).sendKeys("chimimoryo", Key.RETURN);

  // TODO Wait for the results page to load
  await driver.wait(until.titleIs("chimimoryo - Google Search"), 1000)
